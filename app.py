...
def main():
    ...
    if st.button('Understand your feelings'):
        ...
        if results == "Anger":
            ...
            with st.beta_expander("Understand your Feelings in depth"):
        ...
        if results == "Joy":
            ...
            with st.beta_expander("Tips on how stay happy forever"):
        ...
        if results == "Surprise":
            ...
            with st.beta_expander("Want to know more about Surprise ?"):
